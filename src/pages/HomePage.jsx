...
const HomePage = () => {
  ...
  return (
    <section className='flex justify-center items-center max-sm:mt-8'>
      <div className='flex justify-center items-center w-3/4 max-lg:w-full max-lg:px-4 max-sm:flex-col max-sm:space-y-4'>
